package modules.companyManagerRecap.domain;
...
public class Office extends AbstractPersistentBean {
	...
	/** @hidden */
	public static final String MODULE_NAME = "companyManagerRecap";
	...
	/** @hidden */
	public static final String temp23PropertyName = "temp23";
	...
	public String getBizKey() {
		try {
			return org.skyve.util.Binder.formatMessage("Office - {phone}", this);
		}
	...
	/**
	 * {@link #temp23} mutator.
	 * @param temp23	The new value.
	 **/
	@XmlElement
	public void setTemp23(String temp23) {
		preset(temp23PropertyName, temp23);
		this.temp23 = temp23;
	}
}
